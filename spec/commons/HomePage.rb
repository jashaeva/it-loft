...
class HomePage
  ...
  DEFAULT_DATA = {       
    ...
    'requesterEmail' => 'funnicaplanit+request@yandex.ru',
  ...
  text_field(:requesterName,    name: "requesterName" ) #
  text_field(:requesterPhone,   name: "requesterPhone") #
  text_field(:requesterEmail,   name: "requesterEmail") #
  ...
  button(:sendRequest, id: "js-request-full-submit")
